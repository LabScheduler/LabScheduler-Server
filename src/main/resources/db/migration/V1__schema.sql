...
ALTER TABLE `account`
    ADD FOREIGN KEY (`role`) REFERENCES `role` (`name`);
...
ALTER TABLE `lecturer_request`
    ADD FOREIGN KEY (`new_room_id`) REFERENCES `room` (`id`);
ALTER TABLE `lecturer_request`
    ADD FOREIGN KEY (`new_semester_week_id`) REFERENCES `semester_week` (`id`);
ALTER TABLE `lecturer_request`
    ADD FOREIGN KEY (`course_section_id`) REFERENCES `course_section` (`id`);
